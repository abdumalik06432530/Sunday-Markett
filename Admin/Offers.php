...
<div id="wrapper">
  ...
  <div id="content">
    <h2><span style="color:"> Welcome Administrator </span></h2>
    <table width="100%" height="247" border="0" cellpadding="0" cellspacing="0">
      <tr>
	  <td bgcolor="#000000" style="font-size: 16px; font-family: Arial, sans-serif; text-align: center; color: #FFFFFF; vertical-align: middle;">
    <span class="style10">Manage Special Offers</span>
</td>
      ...
      <tr>
	  <td bgcolor="#000000" style="text-align: center; vertical-align: middle; font-family: Arial, sans-serif; color: #FFFFFF; font-size: 18px; padding: 10px;">
    <span class="style10">Special Offers</span>
</td>
